...
const CACHED_FILES = [
  OFFLINE_URL,
  `${ORIGIN_URL}/css/bootstrap.min.css`,
  ...
  `${ORIGIN_URL}/js/jquery-3.2.1.slim.min.js`,
  `${ORIGIN_URL}/js/popper.min.js`,
  `${ORIGIN_URL}/img/logo.png`,
  `${ORIGIN_URL}/img/offline.png`,
  `${ORIGIN_URL}/img/material-icon-2155448_960_720.png`
];
/** FUNCTIONS */
